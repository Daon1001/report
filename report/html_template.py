...
def _svg_bar_chart(data_dict, title="", width=350, height=150, colors=None):
    ...
    chart_h = height - 40
    default_colors = ["#5B3A7A", "#7A4F9A", "#D4698A", "#FFB7C5", "#9B6FB0", "#E8A0BF"]
    if not colors:
    ...
    if title:
        svg += f'<text x="{width//2}" y="14" text-anchor="middle" font-size="11" font-weight="600" fill="#3D2B56">{title}</text>'
...
<div class="page cover-page">
    <!-- 벚꽃 SVG 장식 -->
    <svg class="cherry-deco" viewBox="0 0 1330 940" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <radialGradient id="petal" cx="50%" cy="50%"><stop offset="0%" stop-color="#FFB7C5" stop-opacity="0.7"/><stop offset="100%" stop-color="#FF8FAB" stop-opacity="0.3"/></radialGradient>
        </defs>
        <!-- 큰 꽃 1 -->
        <g transform="translate(1050,120) scale(1.2)" opacity="0.5">
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(0)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(72)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(144)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(216)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(288)"/>
            <circle cx="0" cy="0" r="6" fill="#FFD700" opacity="0.8"/>
        </g>
        <!-- 큰 꽃 2 -->
        <g transform="translate(1180,280) scale(0.9)" opacity="0.4">
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(15)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(87)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(159)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(231)"/>
            <ellipse cx="0" cy="-18" rx="12" ry="22" fill="url(#petal)" transform="rotate(303)"/>
            <circle cx="0" cy="0" r="5" fill="#FFD700" opacity="0.7"/>
        </g>
        <!-- 작은 꽃잎들 (떨어지는) -->
        <ellipse cx="1100" cy="500" rx="6" ry="10" fill="#FFB7C5" opacity="0.35" transform="rotate(30,1100,500)"/>
        <ellipse cx="1230" cy="420" rx="5" ry="8" fill="#FFB7C5" opacity="0.25" transform="rotate(-20,1230,420)"/>
        <ellipse cx="1020" cy="680" rx="7" ry="11" fill="#FFB7C5" opacity="0.2" transform="rotate(50,1020,680)"/>
        <ellipse cx="1260" cy="620" rx="4" ry="7" fill="#FFB7C5" opacity="0.3" transform="rotate(-40,1260,620)"/>
        <ellipse cx="950" cy="380" rx="5" ry="9" fill="#FFB7C5" opacity="0.2" transform="rotate(15,950,380)"/>
        <ellipse cx="1150" cy="750" rx="6" ry="9" fill="#FFB7C5" opacity="0.15" transform="rotate(60,1150,750)"/>
        <!-- 가지 -->
        <path d="M1330,0 Q1100,200 1000,350 Q950,420 980,500" stroke="#8B6F5E" stroke-width="2.5" fill="none" opacity="0.25"/>
        <path d="M1280,0 Q1150,150 1080,250" stroke="#8B6F5E" stroke-width="1.5" fill="none" opacity="0.2"/>
    </svg>
    <div class="cover-bg">
...
<div class="page toc-page">
    ...
    <div style="display:flex;flex-direction:column;gap:28px;max-width:700px;">
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">📊</span><span style="font-weight:600;color:#3D2B56;">기업재무분석</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P03</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">🏦</span><span style="font-weight:600;color:#3D2B56;">신용등급 관리</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P11</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">📈</span><span style="font-weight:600;color:#3D2B56;">기업가치평가</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P13</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">👔</span><span style="font-weight:600;color:#3D2B56;">임원소득보상플랜</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P16</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">💰</span><span style="font-weight:600;color:#3D2B56;">배당플랜</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P20</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">📋</span><span style="font-weight:600;color:#3D2B56;">기업제도정비</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P23</span></div>
        <div style="display:flex;align-items:center;gap:16px;font-size:20px;white-space:nowrap;"><span style="font-size:28px;">⚖️</span><span style="font-weight:600;color:#3D2B56;">노무 컨설팅</span><span style="flex:1;border-bottom:2px dotted #D4698A;margin:0 12px;opacity:0.4;min-width:30px;"></span><span style="color:#5B3A7A;font-weight:700;font-size:15px;">P28</span></div>
    </div>
</div>
"""
...
def _ratio_analysis_page(ratios: dict, years: list, year_labels: list) -> str:
    ...
    chart1 = _svg_bar_chart(stability_data, f"안정성 지표 ({lyl})", 320, 140, ["#5B3A7A","#D4698A","#9B6FB0"])
    chart2 = _svg_bar_chart(profit_data, f"수익성 지표 ({lyl})", 350, 140, ["#5B3A7A","#7A4F9A","#D4698A","#FFB7C5","#9B6FB0"])
...
def _ratio_analysis_page2(ratios: dict, years: list, year_labels: list) -> str:
    ...
    chart3 = _svg_bar_chart(growth_data, f"성장성 ({lyl})", 320, 140, ["#5B3A7A","#D4698A","#9B6FB0"])
    chart4 = _svg_bar_chart(activity_data, f"활동성 ({lyl})", 320, 140, ["#7A4F9A","#D4698A","#FFB7C5"])
...
def _expense_analysis_page(isc: dict, years: list, year_labels: list) -> str:
    ...
    exp_chart = _svg_bar_chart(exp_data, f"매출 대비 경비율 ({lyl})", 320, 140, ["#5B3A7A","#D4698A","#9B6FB0","#FFB7C5"])
...
body { font-family: 'Noto Sans KR', 'Malgun Gothic', sans-serif; font-size: 13px; color: #2D2D2D; line-height: 1.5; background: #E8E0E0; display: flex; flex-direction: column; align-items: center; padding: 10px 0; }
...
@media print {
    * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
    ...
    .cover-page { background: linear-gradient(135deg, #3D2B56 0%, #5B3A7A 40%, #7A4F9A 100%) !important; }
    .section-divider { background: linear-gradient(135deg, #3D2B56, #7A4F9A) !important; }
    .divider-left { background: #5B3A7A !important; }
    .section-badge { background: #5B3A7A !important; color: white !important; }
    .highlight-box { background: #5B3A7A !important; color: white !important; }
    .data-table th { background: linear-gradient(135deg, #5B3A7A, #7A4F9A) !important; color: white !important; }
    .label-cell { background: #F8F0FA !important; }
    .total-row td { background: #F3E8F7 !important; }
    .info-box { background: #FFF5F8 !important; border-left: 4px solid #D4698A !important; }
    .warning-box { background: #FFF8E1 !important; border-left: 4px solid #E6A23C !important; }
    .card { background: #FAF5FC !important; }
    .val-box, .credit-box { background: #FAF5FC !important; }
    img { max-width: 100% !important; }
    .cherry-deco { display: block !important; }
}

/* Cover */
.cover-page { background: linear-gradient(135deg, #3D2B56 0%, #5B3A7A 40%, #7A4F9A 100%); }
.cherry-deco { position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 1; }
.cover-bg { padding: 120px 100px; color: white; height: 85%; position: relative; z-index: 2; }
.cover-company { font-size: 22px; margin-bottom: 12px; font-weight: 300; opacity: 0.85; letter-spacing: 4px; }
.cover-title { font-size: 46px; font-weight: 800; margin-bottom: 30px; line-height: 1.2; letter-spacing: 6px; white-space: nowrap; }
.cover-line { width: 80px; height: 3px; background: linear-gradient(90deg, #FFB7C5, #FF8FAB); margin-bottom: 40px; border-radius: 2px; }
.cover-info { font-size: 16px; }
.cover-info-row { margin-bottom: 8px; }
.cover-label { display: inline-block; width: 80px; color: rgba(255,255,255,0.7); }
.cover-footer { position: absolute; bottom: 0; width: 100%; padding: 20px 100px; background: white; z-index: 2; }
.cover-disclaimer { font-size: 10px; color: #999; }

/* TOC */
.toc-page { padding: 60px 100px; }
.toc-header { font-size: 36px; font-weight: 800; color: #5B3A7A; margin-bottom: 60px; border-top: 3px solid #D4698A; padding-top: 20px; }
...
.toc-text { color: #333; font-weight: 600; }
.toc-row { display: flex; gap: 60px; margin-bottom: 25px; }
.toc-row .toc-item { flex: 1; display: flex; align-items: center; gap: 12px; }
.toc-dots { flex: 1; border-bottom: 2px dotted #D4698A; margin: 0 8px; min-width: 30px; opacity: 0.4; }
.toc-page-num { color: #5B3A7A; font-weight: 700; font-size: 14px; }

/* Section Divider */
.section-divider { display: flex; background: linear-gradient(135deg, #3D2B56, #7A4F9A); }
.divider-left { width: 45%; background: #5B3A7A; position: relative; overflow: hidden; }
.divider-left::after { content: ''; position: absolute; top: -50%; right: -20%; width: 200%; height: 200%; background: radial-gradient(ellipse, rgba(255,183,197,0.15) 0%, transparent 60%); }
.divider-right { width: 55%; display: flex; flex-direction: column; justify-content: center; padding: 0 80px; }
.divider-line { width: 60px; height: 3px; background: linear-gradient(90deg, #FFB7C5, #FF8FAB); margin-bottom: 20px; border-radius: 2px; }
.divider-title { font-size: 44px; font-weight: 800; color: white; letter-spacing: 2px; }

/* Content Page */
.content-page { padding: 0; }
.page-header { display: flex; align-items: center; gap: 16px; padding: 22px 50px; border-bottom: 2px solid #F0E6F3; }
.section-badge { background: linear-gradient(135deg, #5B3A7A, #7A4F9A); color: white; padding: 5px 14px; border-radius: 20px; font-size: 11px; font-weight: 700; letter-spacing: 1px; }
.page-title-main { font-size: 20px; font-weight: 800; color: #3D2B56; }
.page-body { padding: 18px 50px; }

/* Tables */
.data-table { width: 100%; border-collapse: collapse; font-size: 11px; margin-bottom: 12px; }
.data-table th { background: linear-gradient(135deg, #5B3A7A, #7A4F9A); color: white; padding: 7px 8px; text-align: center; font-weight: 600; font-size: 11px; }
.data-table td { padding: 6px 8px; border-bottom: 1px solid #EDE4F0; text-align: center; }
.data-table tr:hover { background: #FDF8FF; }
.data-table .num { text-align: right; font-family: 'Consolas', monospace; }
.data-table .bold-row { font-weight: 700; background: #F8F0FA; text-align: left; }
.data-table .total-row td { font-weight: 700; background: #F3E8F7; border-top: 2px solid #5B3A7A; }
.label-cell { background: #F8F0FA; font-weight: 600; text-align: left !important; width: 140px; }
.indent { padding-left: 24px !important; text-align: left !important; }
.company-table td { padding: 10px 14px; }
.unit-label { font-size: 11px; color: #999; text-align: right; margin-bottom: 8px; }

/* Boxes */
.info-box { background: #FFF5F8; border-left: 4px solid #D4698A; padding: 14px 18px; border-radius: 0 8px 8px 0; font-size: 13px; color: #4A3050; margin-bottom: 16px; line-height: 1.7; }
.warning-box { background: #FFF8E1; border-left: 4px solid #E6A23C; padding: 14px 18px; border-radius: 0 8px 8px 0; font-size: 13px; color: #5A4800; margin-bottom: 16px; line-height: 1.7; }
.highlight-box { background: linear-gradient(135deg, #5B3A7A, #7A4F9A); color: white; border-radius: 12px; padding: 20px 28px; margin-bottom: 20px; }
...
/* Diagnosis */
.diagnosis-grid { display: flex; gap: 16px; flex-wrap: wrap; }
.diag-item { flex: 1; text-align: center; padding: 20px; border-radius: 12px; border: 2px solid #EDE4F0; }
.diag-label { font-size: 14px; color: #666; margin-bottom: 10px; }
.diag-value { font-size: 22px; font-weight: 800; }
.diag-우수 { color: #2E7D32; } .diag-양호 { color: #5B3A7A; } .diag-보통 { color: #E6A23C; } .diag-미흡 { color: #E65100; } .diag-열위 { color: #C62828; }

/* Valuation & Credit */
.valuation-summary { display: flex; gap: 30px; margin-bottom: 20px; }
.val-box { flex: 1; text-align: center; padding: 30px; background: linear-gradient(135deg, #FAF5FC, #F3E8F7); border-radius: 12px; border: 1px solid #EDE4F0; }
.val-label { font-size: 14px; color: #666; margin-bottom: 8px; }
.val-amount { font-size: 32px; font-weight: 800; color: #5B3A7A; }
...
.credit-box { flex: 1; text-align: center; padding: 30px; background: #FAF5FC; border-radius: 12px; }
.credit-label { font-size: 14px; color: #666; margin-bottom: 10px; }
.credit-grade { font-size: 48px; font-weight: 800; color: #5B3A7A; }
...
.card { flex: 1; min-width: 280px; background: linear-gradient(135deg, #FEFBFF, #FAF5FC); border-radius: 12px; padding: 24px; border: 1px solid #EDE4F0; }
.card-title { font-size: 16px; font-weight: 700; color: #5B3A7A; margin-bottom: 10px; }
...
.step-num { background: linear-gradient(135deg, #5B3A7A, #D4698A); color: white; width: 28px; height: 28px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 700; flex-shrink: 0; }
...
def _retirement_plan_page(isc: dict, bs: dict, company: dict, years: list, year_labels: list, sim_params: dict = None) -> str:
    ...
    retire_pretax_chart = _svg_bar_chart({"1배": severance_1x, "2배": severance_2x, "3배": severance_3x}, "배수별 퇴직금 (세전, 만원)", 320, 130, ["#9B6FB0","#7A4F9A","#5B3A7A"])
    retire_aftertax_chart = _svg_bar_chart({"1배": severance_1x - tax_1x, "2배": severance_2x - tax_2x, "3배": severance_3x - tax_3x}, "배수별 퇴직금 (세후, 만원)", 320, 130, ["#D4698A","#B44B6A","#5B3A7A"])
...
<div class="page content-page">
    ...
    <div class="page-body">
        ...
        <div class="warning-box" style="margin-top:16px;">
            ...
            정관배수 2배(2020~) 초과분은 <strong>손금불산입(법인세 추가부담)</strong>되므로, 반드시 정관 개정이 필요합니다.
...
def _salary_tax_simulation_page(isc: dict, company: dict, years: list, sim_params: dict = None) -> str:
    ...
    def calc_dividend_tax(div_amt, exist_salary):
        ...
        sal_ded = 1200 + (exist_salary - 4500) * 0.05 if exist_salary > 4500 else exist_salary * 0.7 if exist_salary <= 500 else 350 + (exist_salary - 500) * 0.4 if exist_salary <= 1500 else 750 + (exist_salary - 1500) * 0.15
        sal_tb = max(exist_salary - sal_ded - 150, 0)
        total_tb = sal_tb + div_amt + gross_up
        total_tx = calc_income_tax(0)[0]  # dummy
        # 직접 세율 적용
    ...
    eff_chart = _svg_bar_chart(eff_chart_data, "실효세율 (%)", 350, 130, ["#5B3A7A","#6B4A8A","#7A4F9A","#8B65AA","#9B6FB0","#D4698A"])
    felt_chart = _svg_bar_chart(felt_chart_data, "체감 담세율 (법인세절감 반영, %)", 350, 130, ["#D4698A","#C45A7A","#B44B6A","#A43C5A","#943D5A","#5B3A7A"])
    ...
    compare_net_chart = _svg_bar_chart({"① 급여": g_net, "② 배당": d_net, "③ 퇴직금": r_net}, "실수령액 (만원)", 320, 140, ["#9B6FB0","#D4698A","#5B3A7A"])
...
<div class="page content-page">
    ...
    <div class="page-body">
        ...
        <div style="display:flex;gap:12px;margin-bottom:10px;">
            <div style="flex:1;text-align:center;padding:12px;background:#FAF5FC;border-radius:10px;border:1px solid #EDE4F0;">
            ...
            <div style="flex:1;text-align:center;padding:12px;background:#FAF5FC;border-radius:10px;border:1px solid #EDE4F0;">
                ...
                <div style="font-size:24px;font-weight:800;color:#5B3A7A;">{felt_rate*100:.1f}%</div>
            </div>
        </div>
