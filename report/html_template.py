...
@media print {
    * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
    ...
    .cover-page { background: linear-gradient(135deg, #4A5FC1 0%, #3B4CA8 50%, #2D3D8F 100%) !important; }
    .section-divider { background: linear-gradient(135deg, #4A5FC1, #2D3D8F) !important; }
    .divider-left { background: #4A5FC1 !important; }
    .section-badge { background: #4A5FC1 !important; color: white !important; }
    .highlight-box { background: #4A5FC1 !important; color: white !important; }
    .data-table th { background: #4A5FC1 !important; color: white !important; }
    .label-cell { background: #F0F2F8 !important; }
    .total-row td { background: #F0F2F8 !important; }
    .info-box { background: #F0F8FF !important; border-left: 4px solid #4A5FC1 !important; }
    .warning-box { background: #FFF8E1 !important; border-left: 4px solid #F57F17 !important; }
    .card { background: #F8F9FC !important; }
    .diag-item { border: 2px solid #E5E7EB !important; }
    .check-item { background: #F8F9FC !important; }
    .val-box { background: #F8F9FC !important; }
    .credit-box { background: #F8F9FC !important; }
