...
<div class="page content-page">
    ...
    <div class="page-body">
        ...
        <table class="data-table company-table">
            ...
            <tr><td class="label-cell">주요제품</td><td>{company.get('주요제품', '-')}</td>
                <td class="label-cell">신용등급</td><td>{company.get('기업신용등급', '-')}</td></tr>
        </table>
        
        <h3 class="subsection-title" style="margin-top:30px;">◆ 재무진단 결과</h3>
        <div class="diagnosis-grid">
            <div class="diag-item">
                <div class="diag-label">성장성</div>
                <div class="diag-value diag-{company.get('재무진단', {}).get('성장성', '보통')}">{company.get('재무진단', {}).get('성장성', '-')}</div>
            </div>
            <div class="diag-item">
                <div class="diag-label">수익성</div>
                <div class="diag-value diag-{company.get('재무진단', {}).get('수익성', '보통')}">{company.get('재무진단', {}).get('수익성', '-')}</div>
            </div>
            <div class="diag-item">
                <div class="diag-label">재무구조</div>
                <div class="diag-value diag-{company.get('재무진단', {}).get('재무구조', '보통')}">{company.get('재무진단', {}).get('재무구조', '-')}</div>
            </div>
            <div class="diag-item">
                <div class="diag-label">활동성</div>
                <div class="diag-value diag-{company.get('재무진단', {}).get('활동성', '보통')}">{company.get('재무진단', {}).get('활동성', '-')}</div>
            </div>
        </div>
    </div>
</div>
